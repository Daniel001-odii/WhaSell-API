...
exports.login = async (req, res) => {
    ...
    try {
        ...
        // Save tokens to cookies
        res.cookie('accessToken', accessToken, { httpOnly: true, maxAge: 15 * 60 * 1000, domain: '.onrender.com', path: '/' });
        res.cookie('refreshToken', refreshToken, { httpOnly: true, maxAge: 7 * 24 * 60 * 60 * 1000, domain: '.onrender.com', path: '/' });
