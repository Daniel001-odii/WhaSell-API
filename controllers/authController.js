...
exports.login = async (req, res) => {
    ...
    try {
        ...
        // Save tokens to cookies
        res.cookie('accessToken', accessToken, { httpOnly: true, secure: true, maxAge: 15 * 60 * 1000, domain: 'https://wha-sell.vercel.app' });
        res.cookie('refreshToken', refreshToken, { httpOnly: true, secure: true, maxAge: 7 * 24 * 60 * 60 * 1000, domain: 'https://wha-sell.vercel.app' });
